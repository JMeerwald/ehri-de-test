...
menus:
  footer:
    identifier: ehri-fur-bestandshaltende-institutionen
    pageRef: ehri-fur-bestandshaltende-institutionen
    weight: 40
---
...
<img src="{{< relURL "images/Schaubild_übersetzt.jpg" >}}" alt="Schaubild">
